...
export function VideoPlayer({
  ...
  // );
    ...
    const handleSeek = useCallback(
      (time: number) => {
        if (isLive) {
          console.log("[LIVE] Seeking not available for live streams");
          return;
        }
 ...
 const handleVideoClick = useCallback(
  ...
  return (
    ...
    >
      ...
      {/* Resume Prompt - Not for live streams */}
      {!isLive &&
        !showInitialOverlay &&
        showResumePrompt &&
        savedPosition &&
      ...
      />
      {!isLive && showResumeToast && savedPosition && (
        <Toast
      ...
      {/* Download Button - Not for live streams */}
      {!isLive && (
