          ...
          const handleSourceClose = () => {
            ...
            if (eventListenersRef.current.timeupdate) {
              videoEl.removeEventListener(
                "timeupdate",
                eventListenersRef.current.timeupdate
              );
            }
            if (eventListenersRef.current.seeking) {
              videoEl.removeEventListener(
                "seeking",
                eventListenersRef.current.seeking
              );
            }
            if (eventListenersRef.current.waiting) {
              videoEl.removeEventListener(
                "waiting",
                eventListenersRef.current.waiting
              );
            }
            if (eventListenersRef.current.pause) {
              videoEl.removeEventListener(
                "pause",
                eventListenersRef.current.pause
              );
            }
            if (eventListenersRef.current.play) {
              videoEl.removeEventListener(
                "play",
                eventListenersRef.current.play
              );
            }
