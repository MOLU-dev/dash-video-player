...
export type RenderState = 'RENDERED' | 'PRESERVED' | 'EVICTED';

export interface ReelPlayerConfig {
  fullyLoadedDistance: number;
  stateSavedDistance: number;
  evictedDistance: number;
