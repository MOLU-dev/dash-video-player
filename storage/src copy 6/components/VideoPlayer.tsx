...
export function VideoPlayer({
  ...
  const {
    ...
    onDoubleTapLeft: () => {
      const seekAmount = seekBackward();
      showIndicator("seek", seekAmount, "left");
    },
    onDoubleTapRight: () => {
      const seekAmount = seekForward();
      showIndicator("seek", seekAmount, "right");
    },
  ...
  return (
    ...
    >
      ...
      {showResumeToast && savedPosition && (
        <Toast
          message={`Resumed from ${savedPosition}`}
